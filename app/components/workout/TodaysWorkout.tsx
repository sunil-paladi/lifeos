    ...
    <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {totalExercises > 0 && (
        ...
        >
          ...
          {/* Finalized */}
          {completed && (
            <div className="mt-4 rounded-lg border border-green-200 bg-white p-3 text-center">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <input
                                    ...
                                    className="mt-1 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 disabled:cursor-not-allowed disabled:bg-slate-100"
                                  />
                                ...
                                <button
                                  ...
                                  className={`mt-4 flex shrink-0 items-center gap-1 rounded-lg px-3 py-2 text-sm font-semibold transition ${
                                    currentSet.completed
